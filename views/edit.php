    ...
    <table id="table_info">
        <tr>
            ...
            <td class="td_form_customer">
                <input type="text" id="name" class="input_form_customer" value='<?= $customer->name ?>'>
            </td>
        </tr>
        <tr>
            <td class="td_form_customer left_td_form_customer">
                <div id="">Ответственное лицо</div>
            </td>
            <td class="td_form_customer">
                <input type="text" id="fio" class="input_form_customer" value="<?= $customer->fio ?>">
            </td>
        </tr>
        <tr>
            <td class="td_form_customer left_td_form_customer">
            ...
            <td class="td_form_customer">
                <input type="text" id="region" class="input_form_customer" value="<?= $customer->region ?>">
            </td>
        </tr>
        <tr>
            <td class="td_form_customer left_td_form_customer">
            ...
            <td class="td_form_customer " colspan="2">
                <input type="text" id="address" class="input_form_customer"  style="width: 240px; float: left;" value="<?= $customer->adres ?>">
        ...
        <tr>
            ...
            <td class="td_form_customer">
                <input type="text" style="text-align: center" id="distance" class="input_form_customer" readonly value="<?= $customer->distance ?>">
            </td>
        </tr>
        <tr>
            <td class="td_form_customer left_td_form_customer">
            ...
            <td class="td_form_customer">
                <input type="text" style="text-align: center" id="coord1" class="input_form_customer" readonly data="<?= $customer->coord1 ?>" value="<?= $customer->coord1 ?>">
            </td>
        </tr>
        <tr>
            <td class="td_form_customer left_td_form_customer">
            ...
            <td class="td_form_customer">
                <input type="text" style="text-align: center" id="coord2" class="input_form_customer" readonly data="<?= $customer->coord2 ?>" value="<?= $customer->coord2 ?>">
            </td>
        </tr>
        <tr>
            <td colspan="2" class="td_form_customer" style="text-align: center">
                <input type="submit" id="save_customer" disabled="disabled" value="Сохранить">
            </td>
        </tr>
    </table>
</div>
            ...
            $.post('<?php echo $this->createUrl('Save')?>',
                {
                    ...
                    if(data['status'] == "OK"){
                        ...
                        map.showInfo("Все изменения сохранены.");
                    }
                    else {
...
<script type="text/javascript">
    $(function () {
        ymaps.ready(function () {
            map = new Map();
            <?php if(($customer->coord1 != null) || ($customer->coord2 != null)) {?>
                map.showByCoordinates(<?= $customer->coord1 ?>, <?= $customer->coord2 ?>);
            <?php } elseif ($customer->adres != null){?>
                map.showByAddress("<?=$customer->region ?>, " + " <?=$customer->adres ?>");
            <?php } else {?>
                map.showErrors("Не указаны адресс и координаты!");
